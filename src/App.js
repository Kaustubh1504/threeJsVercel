...
const App = () => {
    ...
    useEffect(() => {
        ...
        const onSceneReady = async (scene) => {
            ...
            // const gs = new BABYLON.GaussianSplattingMesh("Scene Name",null,scene);

            // console.log("loading object")
            // gs.loadDataAsync("C:/Users/ASUS/3D Objects/ImageToStl.com_kala_brown/kala_brown.gltf").then((model)=>{
            //     console.log(model)
            // })
            // let portalAppearded = false;
    ...
    return <canvas ref={reactCanvas} id="my-canvas" />;
};
